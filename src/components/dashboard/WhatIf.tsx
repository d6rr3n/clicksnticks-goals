    ...
    <div className="relative flex flex-col gap-3.5 overflow-hidden rounded-panel bg-forest p-5 text-cream">
      ...
      <div className="relative flex flex-col gap-3 rounded-card border border-sage-light/20 bg-cream/7 p-3.5">
        <div className="flex items-center justify-between text-[12.5px]">
          ...
          <b className="tabular text-base font-medium text-sage-light">
            {money(extra)}
          </b>
        </div>
        ...
        <input
          ...
          style={{
            background: `linear-gradient(90deg, var(--color-sage) 0 ${(extra / 160) * 100}%, rgba(250,245,239,.20) ${(extra / 160) * 100}%)`,
          }}
        />

        <div className="flex items-end justify-between gap-3">
          <div>
            <p className="text-[11.5px] text-cream/72">Reach your goals</p>
