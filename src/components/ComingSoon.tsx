...
export function ComingSoon({
  ...
  return (
    <section className="rounded-panel bg-surface px-6 py-14 text-center shadow-[0_1px_2px_rgba(36,28,27,.05),0_8px_24px_-12px_rgba(36,28,27,.18)]">
      ...
      <Link
        href="/"
        className="mt-6 inline-flex items-center gap-2 rounded-full bg-sidebar px-5 py-3 text-[13px] text-brand-cream no-underline transition-colors hover:bg-rose-deeper"
      >
        Back to dashboard
